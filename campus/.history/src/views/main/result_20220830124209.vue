  ...
  <div class="box">
    ...
    <div class="three">
      <div class="message" v-for="item in info" :key="item.id">
        ...
        <div class="msgRight">
          <el-button type="text" id="special" @click="dialogVisible = true"
            ><h2>
    ...
    <!-- 分页器 -->
    <div class="footer">
      <el-pagination style="margin-top:20px" background size="large" layout="prev, pager, next" :total="totalPage"> </el-pagination>
    </div>
  </div>
</template>
  ...
  methods:{
    showAllPosition() {
      this.$store
        ...
        .then(() => {
          this.info = this.allPosition;
          this.totalPage = this.allPosition.total;
          console.log(this.allPosition + '121212121212');
        })
        .catch(() => {
