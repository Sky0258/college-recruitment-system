...
import {reqAddCampus, reqSelfInfo,reqShowCampus,reqUpdateInfo,reqDeleteCampus, reqShowEdu, reqAddEdu, reqAddProject, reqShowProject, reqDeleteProject, reqUpload} from "../api";
const state = {
    selfInfo:{},
    showCampus:{},
    showEdu:{},
