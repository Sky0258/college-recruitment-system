...
//搜索接口
export const reqContentSearch = (data)=>requests({url:'/api/pos/likeByCondition',data:data,method:'get'});
...
//收藏信息
export const reqAddLike = (data)=>requests({url:'/api/collection/add',headers:header,params:pid,method:'post'});
