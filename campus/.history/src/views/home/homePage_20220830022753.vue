<template>
  <div class="contain">
    ...
    <el-descriptions-item label="工作要求">{{item.request}}</el-descriptions-item>
    <el-descriptions-item label="工作部门">{{item.department}}</el-descriptions-item>
    <el-descriptions-item label="工作描述">{{item.describe}}</el-descriptions-item>
