...
// 忘记密码发送邮箱验证码
export const reqSendCode = (data)=>requests({url:'/api/user/sendCode',params:data,method:'post'});

// 忘记密码验证后修改密码
export const reqChangPass = (data)=>requests({url:'/api/user/alterPassword',params:data,method:'post'});
