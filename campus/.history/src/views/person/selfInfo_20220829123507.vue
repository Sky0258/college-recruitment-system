<template>
  <div class="box">
    ...
    <div class="contain">
      <span>用户ID：</span><el-input v-model="this.ruleForm.userId" :disabled="true"></el-input><br>
      <span>用户名：</span><el-input v-model="this.ruleForm.username" :disabled="true"></el-input><br>
      <span>性别：</span><el-input v-model="this.ruleForm.orderCount" :disabled="true"></el-input><br>
      <span>政治面貌：</span><el-input v-model="this.ruleForm.orderCount" :disabled="true"></el-input><br>
      <span>电话号码：</span><el-input v-model="this.ruleForm.mobileId" :disabled="true"></el-input><br>
      <span>email：</span><el-input v-model="this.ruleForm.college" :disabled="true"></el-input><br>
      <span>工作意向：</span><el-input v-model="this.ruleForm.orderCount" :disabled="true"></el-input><br>
      <span>个人介绍：</span><el-input v-model="this.ruleForm.breakCount" :disabled="true"></el-input><br>
    </div>
    <div class="button">
