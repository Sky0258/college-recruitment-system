    ...
    <div v-for="item in this.msg" :key="item.id" class="content">
      <el-descriptions style="border-radius: 20px;" :column="1" size="large" :contentStyle="contentStyle" :labelStyle="labelStyle">
        <el-descriptions-item label="学校名称" style="border-radius: 20px;"
          >{{item.school}}</el-descriptions-item
        >
        <el-descriptions-item label="学历"
          >{{item.level}}</el-descriptions-item
        >
        <el-descriptions-item label="开始时间">{{item.fromTime}}</el-descriptions-item>
        <el-descriptions-item label="结束时间">{{item.toTime}}</el-descriptions-item>
      </el-descriptions>
