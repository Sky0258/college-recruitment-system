  ...
  <div class="contain">
    ...
    <div class="three" id="Message">
      ...
      <div class="message" v-for="item in info" :key="item.id">
        ...
        <div class="msgRight">
          <el-button id="special" type="text" @click="dialogVisible = true"
            ><h2>
    ...
    <el-descriptions-item label="职位名称">{{item.pname}}</el-descriptions-item>
    <el-descriptions-item label="职位分类">{{item.pclassify}}</el-descriptions-item>
    <el-descriptions-item label="职责">{{item.presponsibility}}</el-descriptions-item>
    <el-descriptions-item label="工作地点">{{item.workSite}}</el-descriptions-item>
    <el-descriptions-item label="工作要求">{{item.prequest}}</el-descriptions-item>
    <el-descriptions-item label="工作部门">{{item.pdepartment}}</el-descriptions-item>
    <el-descriptions-item label="工作描述">{{item.pdescribe}}</el-descriptions-item>
    ...
    return {
      ...
      info: [
        ...
        },
        {
          ...
          pdescribe: "发传单",
          pdepartment: "校内",
          presponsibility: "发完所分配的传单，并向同学们介绍公司的优惠,发完所分配的传单，并向同学们介绍公司的优惠,发完所分配的传单，并向同学们介绍公司的优惠,发完所分配的传单，并向同学们介绍公司的优惠",
          pclassify: "销售",
          prequest: "有耐心，认真",
          pname: "东华学车宣传员",
        },
