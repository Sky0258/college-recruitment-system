<template>
  <div class="contain">
    ...
    <el-descriptions-item label="职位名称">kooriookami</el-descriptions-item>
    <el-descriptions-item label="职位分类">18100000000</el-descriptions-item>
    <el-descriptions-item label="职责">苏州市</el-descriptions-item>
