<template>
  <div class="contain">
    <el-button @click="showAllPosition">点击</el-button>
    <div class="one">
      <!-- 头部导航栏 -->
      <div class="header">
    ...
    <div class="three">
      ...
      <div class="message" v-for="item in info" :key="item.id">
        ...
        <div class="msgRight">
          ...
          <span>工作内容：{{item.presponsibility}}</span><br>
          <span>工作要求：{{item.prequest}}</span><br><br><br>
          <span>工作地点：{{item.workSite}}</span><br>
        </div>
      </div>
