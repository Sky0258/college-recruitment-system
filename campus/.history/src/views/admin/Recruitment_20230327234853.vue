<template>
  <div class="box">
    <!-- 信息框 -->
    <div class="three">
      <div class="message" v-for="item in allPos" :key="item.id">
        <div class="msgRight">
...
export default {
  data() {
    return {
      info: [
        {
          createTime:"2022-08-21 16:47:05",
id:1,
pclassify:"勤工俭学",
pdepartment:"网安学院",
pdescribe:"很不错的岗位，增进同学交际和应变能力，提升自我",
pflag:2,
pname:"辅导员助理",
prequest:"细心，认真，需要具备一定的excel技能",
presponsibility:"帮助老师处理日常事务，转发信息，整理文案。",
pworkSite:"辅导员办公室",
updateTime:"2022-08-21 16:47:05",
