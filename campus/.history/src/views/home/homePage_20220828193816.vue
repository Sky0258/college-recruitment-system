      ...
      <div class="classify">
        <ul>
          <li class="left">
            ...
            <div>
              <el-button type="text" @click="seeMore()">校外工作</el-button>
              <span>200条相关信息</span>
            </div>  
          </li>
          <li>
            ...
            <div>
              <el-button type="text" @click="seeMore()">校内工作</el-button>
              <span>200条相关信息</span>
            </div>   
          </li>
          <li>
            ...
            <div>
              <el-button type="text" @click="seeMore()">教学工作</el-button>
              <span>200条相关信息</span>
            </div>   
          </li>
          <li class="left">
            ...
            <div>
              <el-button type="text" @click="seeMore()">宣传工作</el-button>
              <span>200条相关信息</span>
            </div>   
          </li>
          <li>
            ...
            <div>
              <el-button type="text" @click="seeMore()">技术工作</el-button>
              <span>200条相关信息</span>
            </div>   
          </li>
          <li>
            ...
            <div>
              <el-button type="text" @click="seeMore()">管理工作</el-button>
              <span>200条相关信息</span>
            </div>   
          </li>
          <li class="left bottom">
            ...
            <div>
              <el-button type="text" @click="seeMore()">勤工俭学</el-button>
              <span>200条相关信息</span>
            </div>   
          </li>
          <li class="bottom">
            ...
            <div>
              <el-button type="text" @click="seeMore()">写作工作</el-button>
              <span>200条相关信息</span>
            </div>   
          </li>
          <li class="bottom">
            ...
            <div>
              <el-button type="text" @click="seeMore()">志愿工作</el-button>
              <span>200条相关信息</span>
            </div>   
          </li>
        </ul>
    ...
    <div class="three">
      ...
      <div class="message" v-for="item in info" :key="item.id">
        ...
        <div class="msgRight">
          ...
          <el-button type="success" size="small" id="submit">立即投递</el-button>
        </div>  
      </div>
      <el-button type="text" id="msgBtn">点击查看更多 ></el-button>
    </div>
    <!-- 底部信息栏 -->
    <div class="four">
...
.four {
  width: 100%;
  height: 60vh;
  background: url("./images/主页4背景.png");
