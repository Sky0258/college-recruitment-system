  ...
  <div class="box">
    ...
    <div class="content">
      ...
      >
        ...
        <!-- 注册表单按钮 -->
        <el-form-item>
          <el-button type="primary" @click="sub2('ruleForm1')"
            >确认提交</el-button>
        </el-form-item>
      </el-form>
      </div>
      ...
      <!-- 步骤3 -->
      <div v-show="active == 3" class="three">
        <i class="el-icon-circle-check"></i><br>
        <span>登录密码更新成功</span><br>
        <el-button type="primary" @click="this.$router.push('/login')">重新登录</el-button>
      </div>
...
.two .el-form--label-left>>>.el-form-item__label {
    font-weight: 600;
    font-size: 16px;
    padding-right: 7px;
}
