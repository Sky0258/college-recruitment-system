...
//后台查看学历情况
export const reqAdminEdu = ()=>requests({url:'/api/backstage/edu/showAll',method:'get'});

//后台查看获奖情况
export const reqAdminAward = ()=>requests({url:'/api/backstage/campus/showAll',method:'get'});

//后台查看项目经历
export const reqAdminProject = ()=>requests({url:'/api/backstage/resume/showAll',method:'get'});
