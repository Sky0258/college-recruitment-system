<template>
  <div>
    <div v-for="item in this.msg" :key="item.id" class="content">
      <el-descriptions class="margin-top content1" :column="1" size="large" :contentStyle="contentStyle" :labelStyle="labelStyle">
...
<style scoped>
.contnet  .margin-top >>> div.el-descriptions__body{
    padding: 100px;
}
</style>