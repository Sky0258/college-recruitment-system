<template>
  ...
  <span>这是一1111111111111111111111111111111111111111111111111111111111段信息</span>
  <span slot="footer" class="dialog-footer">
    <el-button @click="dialogVisible = false">取 消</el-button>
  ...
  data() {
    return {
      ...
      info: [
        ...
        {
          id: 5,
          workSite: "东华学车111111111111",
          flag: 2,
          pdescribe: "发传单",
          pdepartment: "校内",
          presponsibility:
            "发完所分配的传单，并向同学们介绍公司的优惠,发完所分配的传单，并向同学们介绍公司的优惠,发完所分配的传单，并向同学们介绍公司的优惠,发完所分配的传单，并向同学们介绍公司的优惠",
          pclassify: "销售",
          prequest: "有耐心，认真",
          pname: "东华学车宣传员",
        },
