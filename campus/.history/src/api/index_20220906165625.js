...
//后台查看获奖情况
export const reqAdminAward = (data)=>requests({url:'/api/backstage/campus/showAll',method:'get'});

//后台查看项目经历
export const reqAdminProject = (data)=>requests({url:'/api/backstage/pro/showAll',method:'get'});
