<template>
  <div class="box">
    <el-descriptions class="margin-top" :column="3" border size="large" labelStyle="width: 110px">
    ...
    <el-button type="primary" style="margin: 30px;float: right">修改个人信息</el-button>
  </div>
</template>
