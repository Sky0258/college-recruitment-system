...
import { reqAddEdu, reqAddPos, reqAdminAward, reqAdminEdu, reqAdminProject, reqChangeUser, reqDeletePos, reqShowApplyPos, reqShowPos, reqShowUsers, reqUpdatePos,reqShowCompanyPos} from "../api";
const state = {
    allPos:{},
    companyPos:{},
    allUsers:{},
