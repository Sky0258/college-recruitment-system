<template>
  <div class="box">
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column label="职位 ID" prop="pid" align="center" width="100px"> </el-table-column>
      <el-table-column label="职位名称" prop="pname" align="center" width="160px"> </el-table-column>
