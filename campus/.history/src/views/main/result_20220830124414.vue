<template>
  <div class="box">
    ...
    <!-- 分页器 -->
    <div class="footer">
      <el-pagination style="margin-top:20px" background size="large" page-sizes="6" layout="prev, pager, next" :total="totalPage"> </el-pagination>
    </div>
  </div>
</template>
    ...
    showAllPosition() {
      this.$store
        ...
        .then(() => {
          ...
          console.log(this.allPosMessage.total);
        })
        .catch(() => {
